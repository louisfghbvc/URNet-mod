...
# V3 + MCA
python main.py --dir_data ../dataset --model urn3 --scale 2 --patch_size 128 --batch_size 32 --save urnECCA_x2 --loss 1.0*L1+0.25*canny --lr 5e-4 --reset --epochs 300
...
python main.py --dir_data ../dataset --model urn3 --data_test Set5+Set14+B100+Urban100 --scale 2 --pre_train ../experiment/urnECCA_x2/model/model_best.pt --test_only --save_results
